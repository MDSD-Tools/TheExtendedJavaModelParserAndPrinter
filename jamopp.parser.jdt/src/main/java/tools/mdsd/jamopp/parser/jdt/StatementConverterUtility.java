...
class StatementConverterUtility {
	private static HashSet<tools.mdsd.jamopp.model.java.statements.JumpLabel> currentJumpLabels = new HashSet<>();
	
	@SuppressWarnings("unchecked")
	static tools.mdsd.jamopp.model.java.statements.Block convertToBlock(Block block) {
	...
	static tools.mdsd.jamopp.model.java.statements.Statement convertToStatement(Statement statement) {
		if (statement.getNodeType() == ASTNode.ASSERT_STATEMENT) {
			...
			tools.mdsd.jamopp.model.java.statements.Assert result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createAssert();
			...
			tools.mdsd.jamopp.model.java.statements.Break result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createBreak();
			...
			tools.mdsd.jamopp.model.java.statements.Continue result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createContinue();
			...
			tools.mdsd.jamopp.model.java.statements.DoWhileLoop result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createDoWhileLoop();
			...
			tools.mdsd.jamopp.model.java.statements.EmptyStatement result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createEmptyStatement();
			...
			tools.mdsd.jamopp.model.java.statements.ForEachLoop result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createForEachLoop();
			...
			if (exprSt.getExpression().getNodeType() == ASTNode.VARIABLE_DECLARATION_EXPRESSION) {
				tools.mdsd.jamopp.model.java.statements.LocalVariableStatement result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createLocalVariableStatement();
				...
				tools.mdsd.jamopp.model.java.statements.ExpressionStatement result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createExpressionStatement();
			...
			tools.mdsd.jamopp.model.java.statements.ForLoop result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createForLoop();
			if (forSt.initializers().size() == 1 && forSt.initializers().get(0) instanceof VariableDeclarationExpression) {
				...
				tools.mdsd.jamopp.model.java.expressions.ExpressionList ini = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createExpressionList();
			...
			tools.mdsd.jamopp.model.java.statements.Condition result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createCondition();
			...
			tools.mdsd.jamopp.model.java.statements.JumpLabel result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createJumpLabel();
			...
			tools.mdsd.jamopp.model.java.statements.Return result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createReturn();
			...
			tools.mdsd.jamopp.model.java.statements.SynchronizedBlock result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createSynchronizedBlock();
			...
			tools.mdsd.jamopp.model.java.statements.Throw result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createThrow();
			...
			tools.mdsd.jamopp.model.java.statements.TryBlock result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createTryBlock();
			trySt.resources().forEach(obj -> {
				...
				if (resExpr instanceof VariableDeclarationExpression) {
					...
					result.getResources().add((tools.mdsd.jamopp.model.java.references.ElementReference) ReferenceConverterUtility.convertToReference(resExpr));
				}
			});
...
//			frag.extraDimensions().forEach(obj -> BaseConverterUtility.convertToArrayDimensionAfterAndSet((Dimension) obj, locVar));
			...
			tools.mdsd.jamopp.model.java.statements.WhileLoop result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createWhileLoop();
			...
			tools.mdsd.jamopp.model.java.statements.YieldStatement result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createYieldStatement();
	...
	private static tools.mdsd.jamopp.model.java.statements.Switch convertToSwitch(SwitchStatement switchSt) {
	...
	static void convertToSwitchCasesAndSet(tools.mdsd.jamopp.model.java.statements.Switch switchExprSt, List switchStatementList) {
		...
		for (int index = 0; index < switchStatementList.size(); index++) {
			...
			if (st.getNodeType() == ASTNode.SWITCH_CASE) {
				...
				tools.mdsd.jamopp.model.java.statements.ExpressionStatement exprSt = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createExpressionStatement();
	...
	private static tools.mdsd.jamopp.model.java.statements.SwitchCase convertToSwitchCase(SwitchCase switchCase) {
		...
		if (switchCase.isSwitchLabeledRule() && switchCase.isDefault()) {
			result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createDefaultSwitchRule();
		} else if (switchCase.isSwitchLabeledRule() && !switchCase.isDefault()) {
			tools.mdsd.jamopp.model.java.statements.NormalSwitchRule normalRule = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createNormalSwitchRule();
			...
			result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createDefaultSwitchCase();
		} else { // !switchCase.isSwitchLabeledRule() && !switchCase.isDefault()
			tools.mdsd.jamopp.model.java.statements.NormalSwitchCase normalCase = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createNormalSwitchCase();
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.statements.CatchBlock convertToCatchBlock(CatchClause block) {
		tools.mdsd.jamopp.model.java.statements.CatchBlock result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createCatchBlock();
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.variables.AdditionalLocalVariable convertToAdditionalLocalVariable(VariableDeclarationFragment frag) {
		tools.mdsd.jamopp.model.java.variables.AdditionalLocalVariable result;
		IVariableBinding binding = frag.resolveBinding();
		if (binding == null) {
...
//		frag.extraDimensions().forEach(obj -> BaseConverterUtility.convertToArrayDimensionAfterAndSet((Dimension) obj, result));
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.variables.LocalVariable convertToLocalVariable(VariableDeclarationExpression expr) {
