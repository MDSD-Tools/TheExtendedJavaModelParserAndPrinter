...
class BaseConverterUtility {
	...
	static tools.mdsd.jamopp.model.java.types.ClassifierReference convertToClassifierReference(SimpleName simpleName) {
		...
		tools.mdsd.jamopp.model.java.classifiers.Classifier proxy;
	...
	static void convertToNamespacesAndSimpleNameAndSet(Name name, tools.mdsd.jamopp.model.java.commons.NamespaceAwareElement namespaceElement,
	...
	static void convertToNamespacesAndSet(Name name, tools.mdsd.jamopp.model.java.commons.NamespaceAwareElement namespaceElement) {
		if (name.isSimpleName()) {
	...
	static tools.mdsd.jamopp.model.java.types.TypeReference convertToTypeReference(Type t) {
		if (t.isPrimitiveType()) {
			...
			tools.mdsd.jamopp.model.java.types.InferableType ref = tools.mdsd.jamopp.model.java.types.TypesFactory.eINSTANCE.createInferableType();
			...
			if (simT.annotations().size() > 0) {
				tools.mdsd.jamopp.model.java.types.ClassifierReference tempRef = convertToClassifierReference((SimpleName) simT.getName());
			...
			if (parentRef instanceof tools.mdsd.jamopp.model.java.types.ClassifierReference) {
				result = tools.mdsd.jamopp.model.java.types.TypesFactory.eINSTANCE.createNamespaceClassifierReference();
				result.getClassifierReferences().add((tools.mdsd.jamopp.model.java.types.ClassifierReference) parentRef);
			...
			tools.mdsd.jamopp.model.java.types.ClassifierReference childRef = convertToClassifierReference(qualType.getName());
			...
			tools.mdsd.jamopp.model.java.types.NamespaceClassifierReference result;
			tools.mdsd.jamopp.model.java.types.TypeReference parentRef = convertToClassifierOrNamespaceClassifierReference(nqT.getQualifier());
			if (parentRef instanceof tools.mdsd.jamopp.model.java.types.ClassifierReference) {
				result = tools.mdsd.jamopp.model.java.types.TypesFactory.eINSTANCE.createNamespaceClassifierReference();
				result.getClassifierReferences().add((tools.mdsd.jamopp.model.java.types.ClassifierReference) parentRef);
			} else {
			...
			if (ref instanceof tools.mdsd.jamopp.model.java.types.ClassifierReference) {
				...
				tools.mdsd.jamopp.model.java.types.NamespaceClassifierReference containerContainer = (tools.mdsd.jamopp.model.java.types.NamespaceClassifierReference) ref;
	...
	static void convertToArrayDimensionAfterAndSet(Dimension dim, tools.mdsd.jamopp.model.java.arrays.ArrayTypeable arrDimContainer) {
	...
	private static tools.mdsd.jamopp.model.java.arrays.ArrayDimension convertToArrayDimension(Dimension dim) {
		tools.mdsd.jamopp.model.java.arrays.ArrayDimension result = tools.mdsd.jamopp.model.java.arrays.ArraysFactory.eINSTANCE.createArrayDimension();
