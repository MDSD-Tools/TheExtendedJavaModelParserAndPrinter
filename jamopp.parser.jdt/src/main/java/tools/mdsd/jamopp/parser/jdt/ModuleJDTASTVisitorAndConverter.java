...
class ModuleJDTASTVisitorAndConverter extends PackageJDTASTVisitorAndConverter {
	...
	public boolean visit(CompilationUnit node) {
		if (node.getModule() != null) {
			tools.mdsd.jamopp.model.java.containers.Module module = this.convertToModule(node.getModule());
	...
	private tools.mdsd.jamopp.model.java.containers.Module convertToModule(ModuleDeclaration node) {
		tools.mdsd.jamopp.model.java.containers.Module module = JDTResolverUtility.getModule(node.resolveBinding());
		if (node.isOpen()) {
			module.setOpen(tools.mdsd.jamopp.model.java.modifiers.ModifiersFactory.eINSTANCE.createOpen());
		}
	...
	private tools.mdsd.jamopp.model.java.modules.ModuleDirective convertToDirective(ModuleDirective directive) {
		if (directive.getNodeType() == ASTNode.REQUIRES_DIRECTIVE) {
			...
			tools.mdsd.jamopp.model.java.modules.RequiresModuleDirective result = tools.mdsd.jamopp.model.java.modules.ModulesFactory.eINSTANCE.createRequiresModuleDirective();
			reqDir.modifiers().forEach(obj -> {
				ModuleModifier modifier = (ModuleModifier) obj;
				if (modifier.isStatic()) {
					result.setModifier(tools.mdsd.jamopp.model.java.modifiers.ModifiersFactory.eINSTANCE.createStatic());
				} else if (modifier.isTransitive()) {
					result.setModifier(tools.mdsd.jamopp.model.java.modifiers.ModifiersFactory.eINSTANCE.createTransitive());
				}
			});
			...
			if (directive.getNodeType() == ASTNode.OPENS_DIRECTIVE) {
				convertedDir = tools.mdsd.jamopp.model.java.modules.ModulesFactory.eINSTANCE.createOpensModuleDirective();
			} else { // directive.getNodeType() == ASTNode.EXPORTS_DIRECTIVE
				convertedDir = tools.mdsd.jamopp.model.java.modules.ModulesFactory.eINSTANCE.createExportsModuleDirective();
			}
			...
			tools.mdsd.jamopp.model.java.modules.ProvidesModuleDirective result = tools.mdsd.jamopp.model.java.modules.ModulesFactory.eINSTANCE.createProvidesModuleDirective();
			...
			tools.mdsd.jamopp.model.java.modules.UsesModuleDirective result = tools.mdsd.jamopp.model.java.modules.ModulesFactory.eINSTANCE.createUsesModuleDirective();
	...
	private tools.mdsd.jamopp.model.java.modules.ModuleReference convertToModuleReference(Name name) {
		...
		tools.mdsd.jamopp.model.java.containers.Module modProxy = JDTResolverUtility.getModule((IModuleBinding) name.resolveBinding());
		modProxy.setName("");
