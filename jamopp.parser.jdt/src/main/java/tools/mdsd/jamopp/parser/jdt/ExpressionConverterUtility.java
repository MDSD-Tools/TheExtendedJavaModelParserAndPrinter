...
class ExpressionConverterUtility {
	...
	static tools.mdsd.jamopp.model.java.expressions.Expression convertToExpression(Expression expr) {
		if (expr.getNodeType() == ASTNode.ASSIGNMENT) {
			...
			tools.mdsd.jamopp.model.java.expressions.AssignmentExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
				.eINSTANCE.createAssignmentExpression();
			result.setChild((tools.mdsd.jamopp.model.java.expressions.AssignmentExpressionChild) convertToExpression(assign.getLeftHandSide()));
			...
			if (infix.getOperator() == InfixExpression.Operator.CONDITIONAL_OR) {
				...
				if (ex instanceof tools.mdsd.jamopp.model.java.expressions.ConditionalOrExpression) {
					...
					result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createConditionalOrExpression();
					result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ConditionalOrExpressionChild) ex);
				}
				result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ConditionalOrExpressionChild) convertToExpression(infix.getRightOperand()));
				infix.extendedOperands().forEach(obj -> result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ConditionalOrExpressionChild)
				...
				if (ex instanceof tools.mdsd.jamopp.model.java.expressions.ConditionalAndExpression) {
					...
					result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createConditionalAndExpression();
					result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ConditionalAndExpressionChild) ex);
				}
				result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ConditionalAndExpressionChild) convertToExpression(infix.getRightOperand()));
				infix.extendedOperands().forEach(obj -> result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ConditionalAndExpressionChild)
					convertToExpression((Expression) obj)));
				LayoutInformationConverter.convertToMinimalLayoutInformation(result, infix);
				return result;
				...
				if (ex instanceof tools.mdsd.jamopp.model.java.expressions.InclusiveOrExpression) {
					...
					result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createInclusiveOrExpression();
					result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.InclusiveOrExpressionChild) ex);
				}
				result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.InclusiveOrExpressionChild) convertToExpression(infix.getRightOperand()));
				infix.extendedOperands().forEach(obj -> result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.InclusiveOrExpressionChild)
					convertToExpression((Expression) obj)));
				LayoutInformationConverter.convertToMinimalLayoutInformation(result, infix);
				return result;
				...
				if (ex instanceof tools.mdsd.jamopp.model.java.expressions.ExclusiveOrExpression) {
					...
					result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createExclusiveOrExpression();
					result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ExclusiveOrExpressionChild) ex);
				}
				result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ExclusiveOrExpressionChild) convertToExpression(infix.getRightOperand()));
				infix.extendedOperands().forEach(obj -> result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.ExclusiveOrExpressionChild)
					convertToExpression((Expression) obj)));
				LayoutInformationConverter.convertToMinimalLayoutInformation(result, infix);
				return result;
				...
				if (ex instanceof tools.mdsd.jamopp.model.java.expressions.AndExpression) {
					...
					result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createAndExpression();
					result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.AndExpressionChild) ex);					
				}
				result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.AndExpressionChild) convertToExpression(infix.getRightOperand()));
				infix.extendedOperands().forEach(obj -> result.getChildren().add((tools.mdsd.jamopp.model.java.expressions.AndExpressionChild)
					convertToExpression((Expression) obj)));
				LayoutInformationConverter.convertToMinimalLayoutInformation(result, infix);
				return result;
			...
			result.setChild((tools.mdsd.jamopp.model.java.expressions.InstanceOfExpressionChild) convertToExpression(castedExpr.getLeftOperand()));
...
//			BaseConverterUtility.convertToArrayDimensionsAndSet(castedExpr.getRightOperand(), result);
			...
			if (prefixExpr.getOperator() == PrefixExpression.Operator.COMPLEMENT || prefixExpr.getOperator() == PrefixExpression.Operator.NOT
				...
				tools.mdsd.jamopp.model.java.expressions.PrefixUnaryModificationExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
					.eINSTANCE.createPrefixUnaryModificationExpression();
				if (prefixExpr.getOperator() == PrefixExpression.Operator.DECREMENT) {
					result.setOperator(tools.mdsd.jamopp.model.java.operators.OperatorsFactory.eINSTANCE.createMinusMinus());
				} else {
					result.setOperator(tools.mdsd.jamopp.model.java.operators.OperatorsFactory.eINSTANCE.createPlusPlus());
				}
				result.setChild((tools.mdsd.jamopp.model.java.expressions.UnaryModificationExpressionChild) convertToExpression(prefixExpr.getOperand()));
			...
			tools.mdsd.jamopp.model.java.expressions.SuffixUnaryModificationExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
			...
			result.setChild((tools.mdsd.jamopp.model.java.expressions.UnaryModificationExpressionChild) convertToExpression(postfixExpr.getOperand()));
			...
			tools.mdsd.jamopp.model.java.expressions.CastExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
...
//				BaseConverterUtility.convertToArrayDimensionsAndSet(castExpr.getType(), result);
			...
			tools.mdsd.jamopp.model.java.statements.Switch result = tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createSwitch();
			...
			tools.mdsd.jamopp.model.java.expressions.LambdaExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
			...
			if (lambda.parameters().size() > 0 && lambda.parameters().get(0) instanceof VariableDeclarationFragment) {
				...
				if (!lambda.hasParentheses()) {
					param = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createSingleImplicitLambdaParameter();
				} else {
					param = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createImplicitlyTypedLambdaParameters();
				}
				lambda.parameters().forEach(obj -> {
					...
					if (binding != null) {
						...
						nextParam.setTypeReference(tools.mdsd.jamopp.model.java.types.TypesFactory.eINSTANCE.createVoid());
					}
				...
				tools.mdsd.jamopp.model.java.expressions.ExplicitlyTypedLambdaParameters param = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
	...
	private static tools.mdsd.jamopp.model.java.operators.AssignmentOperator convertToAssignmentOperator(Assignment.Operator op) {
		if (op == Assignment.Operator.ASSIGN) {
			...
			return tools.mdsd.jamopp.model.java.operators.OperatorsFactory.eINSTANCE.createAssignmentUnsignedRightShift();
	...
	static tools.mdsd.jamopp.model.java.expressions.ConditionalExpression convertToConditionalExpression(ConditionalExpression expr) {
		tools.mdsd.jamopp.model.java.expressions.ConditionalExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createConditionalExpression();
		result.setChild((tools.mdsd.jamopp.model.java.expressions.ConditionalExpressionChild) convertToExpression(expr.getExpression()));
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.expressions.EqualityExpression convertToEqualityExpression(InfixExpression expr) {
		tools.mdsd.jamopp.model.java.expressions.EqualityExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createEqualityExpression();
	...
	private static tools.mdsd.jamopp.model.java.operators.EqualityOperator convertToEqualityOperator(InfixExpression.Operator op) {
	...
	private static void mergeEqualityExpressionAndExpression(tools.mdsd.jamopp.model.java.expressions.EqualityExpression eqExpr, tools.mdsd.jamopp.model.java.expressions.Expression potChild) {
		if (potChild instanceof tools.mdsd.jamopp.model.java.expressions.EqualityExpressionChild) {
			...
			tools.mdsd.jamopp.model.java.expressions.EqualityExpression expr = (tools.mdsd.jamopp.model.java.expressions.EqualityExpression) potChild;
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.expressions.RelationExpression convertToRelationExpression(InfixExpression expr) {
		tools.mdsd.jamopp.model.java.expressions.RelationExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createRelationExpression();
	...
	private static tools.mdsd.jamopp.model.java.operators.RelationOperator convertToRelationOperator(InfixExpression.Operator op) {
	...
	private static void mergeRelationExpressionAndExpression(tools.mdsd.jamopp.model.java.expressions.RelationExpression relExpr, tools.mdsd.jamopp.model.java.expressions.Expression potChild) {
	...
	private static tools.mdsd.jamopp.model.java.expressions.ShiftExpression convertToShiftExpression(InfixExpression expr) {
		tools.mdsd.jamopp.model.java.expressions.ShiftExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createShiftExpression();
	...
	private static void mergeShiftExpressionAndExpression(tools.mdsd.jamopp.model.java.expressions.ShiftExpression shiftExpr, tools.mdsd.jamopp.model.java.expressions.Expression potChild) {
		if (potChild instanceof tools.mdsd.jamopp.model.java.expressions.ShiftExpressionChild) {
			...
			tools.mdsd.jamopp.model.java.expressions.ShiftExpression expr = (tools.mdsd.jamopp.model.java.expressions.ShiftExpression) potChild;
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.expressions.AdditiveExpression convertToAdditiveExpression(InfixExpression expr) {
		tools.mdsd.jamopp.model.java.expressions.AdditiveExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createAdditiveExpression();
	...
	private static tools.mdsd.jamopp.model.java.operators.AdditiveOperator convertToAdditiveOperator(InfixExpression.Operator op) {
	...
	private static void mergeAdditiveExpressionAndExpression(tools.mdsd.jamopp.model.java.expressions.AdditiveExpression addExpr, tools.mdsd.jamopp.model.java.expressions.Expression potChild) {
		if (potChild instanceof tools.mdsd.jamopp.model.java.expressions.AdditiveExpressionChild) {
			...
			tools.mdsd.jamopp.model.java.expressions.AdditiveExpression expr = (tools.mdsd.jamopp.model.java.expressions.AdditiveExpression) potChild;
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.expressions.MultiplicativeExpression convertToMultiplicativeExpression(InfixExpression expr) {
	...
	private static tools.mdsd.jamopp.model.java.operators.MultiplicativeOperator convertToMultiplicativeOperator(InfixExpression.Operator op) {
	...
	private static void mergeMultiplicativeExpressionAndExpression(tools.mdsd.jamopp.model.java.expressions.MultiplicativeExpression mulExpr, tools.mdsd.jamopp.model.java.expressions.Expression potChild) {
	...
	private static tools.mdsd.jamopp.model.java.expressions.UnaryExpression convertToUnaryExpression(PrefixExpression expr) {
		tools.mdsd.jamopp.model.java.expressions.UnaryExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory.eINSTANCE.createUnaryExpression();
		...
		if (potChild instanceof tools.mdsd.jamopp.model.java.expressions.UnaryExpressionChild) {
			...
			tools.mdsd.jamopp.model.java.expressions.UnaryExpression secRes = (tools.mdsd.jamopp.model.java.expressions.UnaryExpression) potChild;
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.expressions.MethodReferenceExpression convertToMethodReferenceExpression(MethodReference ref) {
		if (ref.getNodeType() == ASTNode.CREATION_REFERENCE) {
			CreationReference crRef = (CreationReference) ref;
			if (crRef.getType().isArrayType()) {
				tools.mdsd.jamopp.model.java.expressions.ArrayConstructorReferenceExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
...
//				BaseConverterUtility.convertToArrayDimensionsAndSet(crRef.getType(), result);
				...
				tools.mdsd.jamopp.model.java.expressions.ClassTypeConstructorReferenceExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
			...
			tools.mdsd.jamopp.model.java.expressions.PrimaryExpressionReferenceExpression result = tools.mdsd.jamopp.model.java.expressions.ExpressionsFactory
			...
			if (ref.getNodeType() == ASTNode.TYPE_METHOD_REFERENCE) {
				...
				if (superRef.getQualifier() != null) {
					tools.mdsd.jamopp.model.java.references.Reference child = ReferenceConverterUtility.convertToReference(superRef.getQualifier());
					...
					lastPart.setSelf(tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createSuper());
				...
				result.setChild((tools.mdsd.jamopp.model.java.expressions.MethodReferenceExpressionChild) convertToExpression(exprRef.getExpression()));
	...
	private static tools.mdsd.jamopp.model.java.expressions.PrimaryExpression convertToPrimaryExpression(Expression expr) {
		if (expr.getNodeType() == ASTNode.BOOLEAN_LITERAL) {
			...
			tools.mdsd.jamopp.model.java.literals.BooleanLiteral result = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createBooleanLiteral();
			...
			tools.mdsd.jamopp.model.java.literals.NullLiteral result = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createNullLiteral();
			LayoutInformationConverter.convertToMinimalLayoutInformation(result, expr);
			return result;
		} else if (expr.getNodeType() == ASTNode.CHARACTER_LITERAL) {
			CharacterLiteral lit = (CharacterLiteral) expr;
			tools.mdsd.jamopp.model.java.literals.CharacterLiteral result = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createCharacterLiteral();
