...
class ReferenceConverterUtility {
	...
	private static tools.mdsd.jamopp.model.java.references.Reference internalConvertToReference(Expression expr) {
		if (expr instanceof Annotation) {
			...
			tools.mdsd.jamopp.model.java.arrays.ArraySelector selector = tools.mdsd.jamopp.model.java.arrays.ArraysFactory.eINSTANCE.createArraySelector();
...
//				BaseConverterUtility.convertToArrayDimensionsAndSet(arr.getType(), result, arr.dimensions().size());
			...
			if (arr.getType().isParameterizedType() && ((ParameterizedType) arr.getType()).typeArguments().size() == 0) {
				result = tools.mdsd.jamopp.model.java.instantiations.InstantiationsFactory.eINSTANCE.createNewConstructorCallWithInferredTypeArguments();
			} else {
				result = tools.mdsd.jamopp.model.java.instantiations.InstantiationsFactory.eINSTANCE.createNewConstructorCall();
			}
			...
			tools.mdsd.jamopp.model.java.references.Reference parent = internalConvertToReference(arr.getExpression());
			tools.mdsd.jamopp.model.java.references.IdentifierReference result = convertToIdentifierReference(arr.getName());
			parent.setNext(result);
			return result;
			...
			tools.mdsd.jamopp.model.java.references.StringReference result = tools.mdsd.jamopp.model.java.references.ReferencesFactory.eINSTANCE.createStringReference();
			...
			tools.mdsd.jamopp.model.java.references.SelfReference partOne = tools.mdsd.jamopp.model.java.references.ReferencesFactory.eINSTANCE.createSelfReference();
			...
			tools.mdsd.jamopp.model.java.references.IdentifierReference partTwo = convertToIdentifierReference(arr.getName());
			...
			tools.mdsd.jamopp.model.java.references.MethodCall partTwo = tools.mdsd.jamopp.model.java.references.ReferencesFactory.eINSTANCE.createMethodCall();
			...
			tools.mdsd.jamopp.model.java.references.SelfReference result = tools.mdsd.jamopp.model.java.references.ReferencesFactory.eINSTANCE.createSelfReference();
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.references.MethodCall convertToMethodCall(MethodInvocation arr) {
		tools.mdsd.jamopp.model.java.references.Reference parent = null;
		if (arr.getExpression() != null) {
			parent = internalConvertToReference(arr.getExpression());
		}
		tools.mdsd.jamopp.model.java.references.MethodCall result = tools.mdsd.jamopp.model.java.references.ReferencesFactory.eINSTANCE.createMethodCall();
		arr.typeArguments().forEach(obj -> result.getCallTypeArguments().add(BaseConverterUtility.convertToTypeArgument((Type) obj)));
		arr.arguments().forEach(obj -> result.getArguments().add(ExpressionConverterUtility.convertToExpression((Expression) obj)));
	...
	private static tools.mdsd.jamopp.model.java.references.IdentifierReference convertToIdentifierReference(Name name) {
		if (name.isSimpleName()) {
			return convertToIdentifierReference((SimpleName) name);
		} else { // name.isQualifiedName()
			QualifiedName qualifiedName = (QualifiedName) name;
			tools.mdsd.jamopp.model.java.references.IdentifierReference parent = convertToIdentifierReference(qualifiedName.getQualifier());
			tools.mdsd.jamopp.model.java.references.IdentifierReference child = convertToIdentifierReference(qualifiedName.getName());
			parent.setNext(child);
			return child;
		}
	}
	
	private static tools.mdsd.jamopp.model.java.references.IdentifierReference convertToIdentifierReference(SimpleName name) {
		tools.mdsd.jamopp.model.java.references.IdentifierReference result = tools.mdsd.jamopp.model.java.references.ReferencesFactory.eINSTANCE.createIdentifierReference();
	...
	private static tools.mdsd.jamopp.model.java.references.Reference internalConvertToReference(Type t) {
		if (t.isNameQualifiedType()) {
			...
			tools.mdsd.jamopp.model.java.references.IdentifierReference parent = convertToIdentifierReference(nqType.getQualifier());
			tools.mdsd.jamopp.model.java.references.IdentifierReference child = convertToIdentifierReference(nqType.getName());
			parent.setNext(child);
			...
			tools.mdsd.jamopp.model.java.references.IdentifierReference child = convertToIdentifierReference(qType.getName());
			...
			tools.mdsd.jamopp.model.java.references.IdentifierReference result = convertToIdentifierReference(sType.getName());
	...
	private static tools.mdsd.jamopp.model.java.references.Reference internalConvertToReference(Statement st) {
		if (st.getNodeType() == ASTNode.CONSTRUCTOR_INVOCATION) {
			...
			if (invoc.getExpression() != null) {
				tools.mdsd.jamopp.model.java.references.Reference parent = internalConvertToReference(invoc.getExpression());
				parent.setNext(result);
			}
			return result;
		}
