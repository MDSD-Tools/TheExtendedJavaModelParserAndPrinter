...
public class JDTResolverUtility {
	...
	static tools.mdsd.jamopp.model.java.containers.Module getModule(IModuleBinding binding) {
		moduleBindings.add(binding);
		return getModule(binding.getName());
	}
	
	static tools.mdsd.jamopp.model.java.containers.Module getModule(String modName) {
		if (modBindToMod.containsKey(modName)) {
			...
			if (result == null) {
				result = tools.mdsd.jamopp.model.java.containers.ContainersFactory.eINSTANCE.createModule();
			}
	...
	static tools.mdsd.jamopp.model.java.containers.Package getPackage(IPackageBinding binding) {
		packageBindings.add(binding);
		return getPackage(binding.getName());
	}
	
	private static tools.mdsd.jamopp.model.java.containers.Package getPackage(String packageName) {
		if (nameToPackage.containsKey(packageName)) {
			...
			if (result == null) {
				result = tools.mdsd.jamopp.model.java.containers.ContainersFactory.eINSTANCE.createPackage();
			}
	...
	static tools.mdsd.jamopp.model.java.classifiers.Annotation getAnnotation(ITypeBinding binding) {
		typeBindings.add(binding);
		return getAnnotation(convertToTypeName(binding));
	}
	
	static tools.mdsd.jamopp.model.java.classifiers.Annotation getAnnotation(String annotName) {
		if (typeBindToAnnot.containsKey(annotName)) {
			...
			tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier potClass = JavaClasspath.get().getConcreteClassifier(annotName);
	...
	static tools.mdsd.jamopp.model.java.classifiers.Enumeration getEnumeration(ITypeBinding binding) {
		String enumName = convertToTypeName(binding);
		if (typeBindToEnum.containsKey(enumName)) {
			return typeBindToEnum.get(enumName);
		} else {
			typeBindings.add(binding);
			tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier classifier = JavaClasspath.get().getConcreteClassifier(enumName);
			tools.mdsd.jamopp.model.java.classifiers.Enumeration result;
			if (classifier != null && classifier instanceof tools.mdsd.jamopp.model.java.classifiers.Enumeration) {
				result = (tools.mdsd.jamopp.model.java.classifiers.Enumeration) classifier;
			} else {
				result = tools.mdsd.jamopp.model.java.classifiers.ClassifiersFactory.eINSTANCE.createEnumeration();
			}
	...
	static tools.mdsd.jamopp.model.java.classifiers.Class getClass(ITypeBinding binding) {
		typeBindings.add(binding);
		return getClass(convertToTypeName(binding));
	}
	
	static tools.mdsd.jamopp.model.java.classifiers.Interface getInterface(ITypeBinding binding) {
		...
		if (typeBindToInterface.containsKey(interName)) {
			...
			tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier classifier = JavaClasspath.get().getConcreteClassifier(interName);
			if (classifier != null && classifier instanceof tools.mdsd.jamopp.model.java.classifiers.Interface) {
				result = (tools.mdsd.jamopp.model.java.classifiers.Interface) classifier;
			} else {
				result = tools.mdsd.jamopp.model.java.classifiers.ClassifiersFactory.eINSTANCE.createInterface();
			}
	...
	static tools.mdsd.jamopp.model.java.generics.TypeParameter getTypeParameter(ITypeBinding binding) {
		...
		if (typeBindToTP.containsKey(paramName)) {
			...
			typeBindings.add(binding);
			tools.mdsd.jamopp.model.java.generics.TypeParameter result = tools.mdsd.jamopp.model.java.generics.GenericsFactory.eINSTANCE.createTypeParameter();
			typeBindToTP.put(paramName, result);
			return result;
		}
	}
	
	static tools.mdsd.jamopp.model.java.classifiers.Classifier getClassifier(ITypeBinding binding) {
		String typeName = convertToTypeName(binding);
		tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier potClass = JavaClasspath.get().getConcreteClassifier(typeName);
		if (potClass != null) {
			return potClass;
		}
	...
	static tools.mdsd.jamopp.model.java.members.InterfaceMethod getInterfaceMethod(String methodName) {
	...
	private static tools.mdsd.jamopp.model.java.members.InterfaceMethod createNewInterfaceMethod() {
		...
		result.setTypeReference(tools.mdsd.jamopp.model.java.types.TypesFactory.eINSTANCE.createVoid());
		result.setStatement(tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createEmptyStatement());
		return result;
	}
	
	static tools.mdsd.jamopp.model.java.members.InterfaceMethod getInterfaceMethod(IMethodBinding binding) {
		binding = binding.getMethodDeclaration();
		...
		if (methBindToInter.containsKey(methName)) {
			...
			tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier classifier =
				(tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier) getClassifier(binding.getDeclaringClass());
	...
	static tools.mdsd.jamopp.model.java.members.ClassMethod getClassMethod(String methodName) {
	...
	private static tools.mdsd.jamopp.model.java.members.ClassMethod createNewClassMethod() {
	...
	static tools.mdsd.jamopp.model.java.members.ClassMethod getClassMethod(IMethodBinding binding) {
		binding = binding.getMethodDeclaration();
		methodBindings.add(binding);
		String methName = convertToMethodName(binding);
			...
			if (classifier != null) {
				for (tools.mdsd.jamopp.model.java.members.Member mem : classifier.getMembers()) {
					if (mem instanceof tools.mdsd.jamopp.model.java.members.ClassMethod) {
						result = checkMethod((tools.mdsd.jamopp.model.java.members.Method) mem,
							binding);
						if (result != null) {
							break;
						}
	...
	private static <T extends tools.mdsd.jamopp.model.java.members.Method> T checkMethod(tools.mdsd.jamopp.model.java.members.Method mem,
		...
		if (mem.getName().equals(binding.getName())) {
			...
			if (binding.getParameterTypes().length + receiveOffset == meth.getParameters().size()) {
				...
				for (int i = 0; i < binding.getParameterTypes().length; i++) {
					...
					tools.mdsd.jamopp.model.java.parameters.Parameter currentParam = meth.getParameters().get(i + receiveOffset);
	...
	private static String convertToTypeName(tools.mdsd.jamopp.model.java.types.TypeReference ref) {
		if (ref instanceof tools.mdsd.jamopp.model.java.types.ClassifierReference) {
			tools.mdsd.jamopp.model.java.types.ClassifierReference convRef = (tools.mdsd.jamopp.model.java.types.ClassifierReference) ref;
			if (convRef.getTarget() instanceof tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier) {
				return ((tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier) convRef.getTarget()).getQualifiedName();
		...
		} else if (ref instanceof tools.mdsd.jamopp.model.java.types.NamespaceClassifierReference) {
			tools.mdsd.jamopp.model.java.types.NamespaceClassifierReference nRef = (tools.mdsd.jamopp.model.java.types.NamespaceClassifierReference) ref;
	...
	static tools.mdsd.jamopp.model.java.members.Constructor getConstructor(IMethodBinding binding) {
		String methName = convertToMethodName(binding);
		if (methBindToConstr.containsKey(methName)) {
			...
			if (potClass != null) {
				outerLoop: for (tools.mdsd.jamopp.model.java.members.Member mem : potClass.getMembers()) {
					if (mem instanceof tools.mdsd.jamopp.model.java.members.Constructor && mem.getName().equals(binding.getName())) {
						tools.mdsd.jamopp.model.java.members.Constructor con = (tools.mdsd.jamopp.model.java.members.Constructor) mem;
						int receiveOffset = 0;
						if (binding.getDeclaredReceiverType() != null) {
							receiveOffset = 1;
						}
						if (con.getParameters().size() == binding.getParameterTypes().length + receiveOffset) {
							if (receiveOffset == 1 && !(con.getParameters().get(0) instanceof tools.mdsd.jamopp.model.java.parameters.ReceiverParameter
								&& convertToTypeName(binding.getDeclaredReceiverType()).equals(
			...
			if (result == null) {
				result = tools.mdsd.jamopp.model.java.members.MembersFactory.eINSTANCE.createConstructor();
	...
	static tools.mdsd.jamopp.model.java.members.Constructor getConstructor(String methName) {
		if (methBindToConstr.containsKey(methName)) {
			return methBindToConstr.get(methName);
		} else {
	...
	static tools.mdsd.jamopp.model.java.members.Method getMethod(IMethodBinding binding) {
	...
	static tools.mdsd.jamopp.model.java.classifiers.Class getClass(String typeName) {
		if (typeBindToClass.containsKey(typeName)) {
			...
			if (potClass instanceof tools.mdsd.jamopp.model.java.classifiers.Class) {
				...
				result = tools.mdsd.jamopp.model.java.classifiers.ClassifiersFactory.eINSTANCE.createClass();
			}
	...
	static tools.mdsd.jamopp.model.java.classifiers.AnonymousClass getAnonymousClass(String typeName) {
		if (nameToAnonymousClass.containsKey(typeName)) {
			return nameToAnonymousClass.get(typeName);
		} else {
			tools.mdsd.jamopp.model.java.classifiers.AnonymousClass result = tools.mdsd.jamopp.model.java.classifiers.ClassifiersFactory.eINSTANCE.createAnonymousClass();
			nameToAnonymousClass.put(typeName, result);
			return result;
		}
	}
	
	static tools.mdsd.jamopp.model.java.classifiers.AnonymousClass getAnonymousClass(ITypeBinding binding) {
		String typeName = convertToTypeName(binding);
	...
	static tools.mdsd.jamopp.model.java.members.Field getField(String name) {
		if (nameToField.containsKey(name)) {
			return nameToField.get(name);
		} else {
			tools.mdsd.jamopp.model.java.members.Field result = tools.mdsd.jamopp.model.java.members.MembersFactory.eINSTANCE.createField();
			nameToField.put(name, result);
			return result;
		}
	}
	
	static tools.mdsd.jamopp.model.java.members.Field getField(IVariableBinding binding) {
		...
		if (nameToField.containsKey(varName)) {
			...
			if (binding.getDeclaringClass() != null) {
				potClass = (tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier) getClassifier(binding.getDeclaringClass());
			}
			...
			if (result == null) {
				result = tools.mdsd.jamopp.model.java.members.MembersFactory.eINSTANCE.createField();
				result.setTypeReference(tools.mdsd.jamopp.model.java.types.TypesFactory.eINSTANCE.createInt());
			}
	...
	static tools.mdsd.jamopp.model.java.members.EnumConstant getEnumConstant(IVariableBinding binding) {
		...
		if (nameToEnumConst.containsKey(enumCN)) {
			...
			if (result == null) {
				result = tools.mdsd.jamopp.model.java.members.MembersFactory.eINSTANCE.createEnumConstant();
			}
	...
	static tools.mdsd.jamopp.model.java.members.EnumConstant getEnumConstant(String enumCN) {
		if (nameToEnumConst.containsKey(enumCN)) {
			return nameToEnumConst.get(enumCN);
		} else {
			tools.mdsd.jamopp.model.java.members.EnumConstant result = tools.mdsd.jamopp.model.java.members.MembersFactory.eINSTANCE.createEnumConstant();
			nameToEnumConst.put(enumCN, result);
			return result;
		}
	}
	
	static tools.mdsd.jamopp.model.java.members.AdditionalField getAdditionalField(String name) {
		if (nameToAddField.containsKey(name)) {
			return nameToAddField.get(name);
		} else {
			tools.mdsd.jamopp.model.java.members.AdditionalField result = tools.mdsd.jamopp.model.java.members.MembersFactory.eINSTANCE.createAdditionalField();
			nameToAddField.put(name, result);
			return result;
		}
	}
	
	static tools.mdsd.jamopp.model.java.members.AdditionalField getAdditionalField(IVariableBinding binding) {
		String varName = convertToFieldName(binding);
		if (nameToAddField.containsKey(varName)) {
			...
			if (potClass != null) {
				outerLoop: for (tools.mdsd.jamopp.model.java.members.Member mem : potClass.getMembers()) {
					if (mem instanceof tools.mdsd.jamopp.model.java.members.Field) {
						tools.mdsd.jamopp.model.java.members.Field field = (tools.mdsd.jamopp.model.java.members.Field) mem;
			...
			if (result == null) {
				result = tools.mdsd.jamopp.model.java.members.MembersFactory.eINSTANCE.createAdditionalField();
			}
	...
	static tools.mdsd.jamopp.model.java.variables.LocalVariable getLocalVariable(IVariableBinding binding) {
		variableBindings.add(binding);
		return getLocalVariable(convertToParameterName(binding, true));
	}
	
	static tools.mdsd.jamopp.model.java.variables.LocalVariable getLocalVariable(String varName) {
		if (nameToLocVar.containsKey(varName)) {
			return nameToLocVar.get(varName);
		} else {
			tools.mdsd.jamopp.model.java.variables.LocalVariable result = tools.mdsd.jamopp.model.java.variables.VariablesFactory.eINSTANCE.createLocalVariable();
			nameToLocVar.put(varName, result);
			return result;
		}
	}
	
	static tools.mdsd.jamopp.model.java.variables.AdditionalLocalVariable getAdditionalLocalVariable(IVariableBinding binding) {
		variableBindings.add(binding);
		return getAdditionalLocalVariable(convertToParameterName(binding, true));
	}
	
	static tools.mdsd.jamopp.model.java.variables.AdditionalLocalVariable getAdditionalLocalVariable(String varName) {
		if (nameToAddLocVar.containsKey(varName)) {
			return nameToAddLocVar.get(varName);
		} else {
			tools.mdsd.jamopp.model.java.variables.AdditionalLocalVariable result = tools.mdsd.jamopp.model.java.variables.VariablesFactory.eINSTANCE.createAdditionalLocalVariable();
			nameToAddLocVar.put(varName, result);
			return result;
		}
	}
	
	static tools.mdsd.jamopp.model.java.parameters.OrdinaryParameter getOrdinaryParameter(IVariableBinding binding) {
		variableBindings.add(binding);
		String paramName = convertToParameterName(binding, true);
		return getOrdinaryParameter(paramName);
	}
	
	static tools.mdsd.jamopp.model.java.parameters.OrdinaryParameter getOrdinaryParameter(String paramName) {
		if (nameToOrdParam.containsKey(paramName)) {
			return nameToOrdParam.get(paramName);
		} else {
			tools.mdsd.jamopp.model.java.parameters.OrdinaryParameter result = tools.mdsd.jamopp.model.java.parameters.ParametersFactory.eINSTANCE.createOrdinaryParameter();
			nameToOrdParam.put(paramName, result);
			return result;
		}
	}
	
	static tools.mdsd.jamopp.model.java.parameters.VariableLengthParameter getVariableLengthParameter(IVariableBinding binding) {
		String paramName = convertToParameterName(binding, true);
	...
	static tools.mdsd.jamopp.model.java.parameters.CatchParameter getCatchParameter(IVariableBinding binding) {
		variableBindings.add(binding);
		return getCatchParameter(convertToParameterName(binding, true));
	}
	
	static tools.mdsd.jamopp.model.java.parameters.CatchParameter getCatchParameter(String paramName) {
		if (nameToCatchParam.containsKey(paramName)) {
			return nameToCatchParam.get(paramName);
		} else {
			tools.mdsd.jamopp.model.java.parameters.CatchParameter result = tools.mdsd.jamopp.model.java.parameters.ParametersFactory.eINSTANCE.createCatchParameter();
	...
	static tools.mdsd.jamopp.model.java.references.ReferenceableElement getReferencableElement(IVariableBinding binding) {
	...
	static tools.mdsd.jamopp.model.java.references.ReferenceableElement getReferenceableElementByNameMatching(String name) {
			...
			if (field.eContainer() == null) {
				...
				if (varBind == null || varBind.getDeclaringClass() == null) {
					...
					if (cla == null) {
						...
						if (nameToAnonymousClass.containsKey(typeName)) {
							tools.mdsd.jamopp.model.java.classifiers.AnonymousClass anonClass = nameToAnonymousClass.get(typeName);
							...
							&& cla instanceof tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier) {
						var i = (tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier) cla;
	...
	@SuppressWarnings("unused")
	private static void completeMethod(String methodName, tools.mdsd.jamopp.model.java.members.Member method) {
	...
	private static void addToSyntheticClass(tools.mdsd.jamopp.model.java.members.Member member) {
	...
	private static void convertPureTypeBindings() {
		...
		do {
			oldSize = newSize;
			HashMap<String, ? extends tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier> map =
				(HashMap<String, tools.mdsd.jamopp.model.java.classifiers.Annotation>) typeBindToAnnot.clone();
			...
			map.forEach(JDTResolverUtility::convertPureTypeBinding);
			HashMap<String, tools.mdsd.jamopp.model.java.containers.Package> mapP =
				(HashMap<String, tools.mdsd.jamopp.model.java.containers.Package>) nameToPackage.clone();
			mapP.forEach(JDTResolverUtility::convertPurePackageBinding);
			HashMap<String, tools.mdsd.jamopp.model.java.containers.Module> mapM =
				(HashMap<String, tools.mdsd.jamopp.model.java.containers.Module>) modBindToMod.clone();
	...
	private static void convertPureTypeBinding(String typeName, tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier classifier) {
		...
		if (typeBind == null) {
			...
			if (typeBind.isTopLevel()) {
				...
				tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier parentClassifier =
					(tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier) getClassifier(typeBind.getDeclaringClass());
				...
				if (!elementType.isPrimitive() && !elementType.isTypeVariable()) {
					convertPureTypeBinding(typeName, (tools.mdsd.jamopp.model.java.classifiers.ConcreteClassifier)
						getClassifier(elementType));
				}
			}
		}
		if (classifier.eContainer() == null) {
			tools.mdsd.jamopp.model.java.containers.CompilationUnit cu = tools.mdsd.jamopp.model.java.containers.ContainersFactory.eINSTANCE.createCompilationUnit();
			cu.setName("");
	...
	private static void convertPurePackageBinding(String packageName, tools.mdsd.jamopp.model.java.containers.Package pack) {
	...
	private static void convertPureModuleBinding(String modName, tools.mdsd.jamopp.model.java.containers.Module module) {
	...
	private static void escapeIdentifier(Notifier not) {
		if (not instanceof tools.mdsd.jamopp.model.java.commons.NamedElement) {
			tools.mdsd.jamopp.model.java.commons.NamedElement ele = (tools.mdsd.jamopp.model.java.commons.NamedElement) not;
			StringBuilder builder = new StringBuilder();
