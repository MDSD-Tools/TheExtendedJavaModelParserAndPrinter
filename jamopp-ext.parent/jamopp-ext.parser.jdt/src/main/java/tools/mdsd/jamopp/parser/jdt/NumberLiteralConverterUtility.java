...
class NumberLiteralConverterUtility {
	...
	static tools.mdsd.jamopp.model.java.literals.Literal convertToLiteral(NumberLiteral literal) {
		...
		if (string.startsWith(BIN_PREFIX) && string.endsWith(LONG_SUFFIX)) {
			tools.mdsd.jamopp.model.java.literals.BinaryLongLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createBinaryLongLiteral();
			...
			tools.mdsd.jamopp.model.java.literals.BinaryIntegerLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createBinaryIntegerLiteral();
			...
			tools.mdsd.jamopp.model.java.literals.HexFloatLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createHexFloatLiteral();
			...
			tools.mdsd.jamopp.model.java.literals.HexDoubleLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createHexDoubleLiteral();
			lit.setHexValue(Double.parseDouble(string));
			result = lit;
		} else if (string.startsWith(HEX_PREFIX) && string.endsWith(LONG_SUFFIX)) {
			tools.mdsd.jamopp.model.java.literals.HexLongLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createHexLongLiteral();
			...
			tools.mdsd.jamopp.model.java.literals.HexIntegerLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createHexIntegerLiteral();
			lit.setHexValue(new BigInteger(string.substring(HEX_PREFIX.length()), HEX_BASE));
			result = lit;
		} else if (string.endsWith(FLOAT_SUFFIX)) {
			tools.mdsd.jamopp.model.java.literals.DecimalFloatLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createDecimalFloatLiteral();
			...
			tools.mdsd.jamopp.model.java.literals.DecimalDoubleLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createDecimalDoubleLiteral();
			...
			tools.mdsd.jamopp.model.java.literals.DecimalLongLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createDecimalLongLiteral();
			...
			tools.mdsd.jamopp.model.java.literals.OctalLongLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createOctalLongLiteral();
			lit.setOctalValue(new BigInteger(string.substring(OCT_PREFIX.length(), string.length() - LONG_SUFFIX.length()), OCT_BASE));
			result = lit;
		} else {
			tools.mdsd.jamopp.model.java.literals.OctalIntegerLiteral lit = tools.mdsd.jamopp.model.java.literals.LiteralsFactory.eINSTANCE.createOctalIntegerLiteral();
