...
public class ConcreteClassifierExtension {
	...
	public static EList<ClassifierReference> getSuperTypeReferences(ConcreteClassifier me) {
		...
		if (me instanceof tools.mdsd.jamopp.model.java.classifiers.Class) {
			tools.mdsd.jamopp.model.java.classifiers.Class javaClass = (tools.mdsd.jamopp.model.java.classifiers.Class) me;
