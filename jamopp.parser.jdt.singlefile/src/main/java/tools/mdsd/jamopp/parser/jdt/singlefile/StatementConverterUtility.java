...
class StatementConverterUtility {
	...
	static tools.mdsd.jamopp.model.java.statements.Block convertToBlock(Block block) {
		tools.mdsd.jamopp.model.java.statements.Block result =
	...
	static tools.mdsd.jamopp.model.java.statements.Statement convertToStatement(Statement statement) {
		if (statement.getNodeType() == ASTNode.ASSERT_STATEMENT) {
			...
			tools.mdsd.jamopp.model.java.statements.Assert result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createAssert();
			...
			tools.mdsd.jamopp.model.java.statements.Break result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createBreak();
			...
			tools.mdsd.jamopp.model.java.statements.Continue result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createContinue();
			...
			tools.mdsd.jamopp.model.java.statements.DoWhileLoop result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createDoWhileLoop();
			...
			tools.mdsd.jamopp.model.java.statements.EmptyStatement result =
			...
			tools.mdsd.jamopp.model.java.statements.ForEachLoop result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createForEachLoop();
			...
			tools.mdsd.jamopp.model.java.statements.ForLoop result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createForLoop();
			...
			tools.mdsd.jamopp.model.java.statements.Condition result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createCondition();
			...
			tools.mdsd.jamopp.model.java.statements.JumpLabel result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createJumpLabel();
			...
			tools.mdsd.jamopp.model.java.statements.Return result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createReturn();
			...
			tools.mdsd.jamopp.model.java.statements.Throw result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createThrow();
			...
			tools.mdsd.jamopp.model.java.statements.TryBlock result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createTryBlock();
			trySt.resources().forEach(obj -> {
				...
				if (resExpr instanceof VariableDeclarationExpression) {
					...
					result.getResources().add((tools.mdsd.jamopp.model.java.references
			...
			tools.mdsd.jamopp.model.java.variables.LocalVariable locVar =
					tools.mdsd.jamopp.model.java.variables.VariablesFactory.eINSTANCE.createLocalVariable();
			...
			tools.mdsd.jamopp.model.java.statements.WhileLoop result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createWhileLoop();
			...
			tools.mdsd.jamopp.model.java.statements.YieldStatement result =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createYieldStatement();
	...
	static void convertToSwitchCasesAndSet(tools.mdsd.jamopp.model.java.statements.Switch switchExprSt,
	...
	private static tools.mdsd.jamopp.model.java.statements.SwitchCase convertToSwitchCase(SwitchCase switchCase) {
		...
		if (switchCase.isSwitchLabeledRule() && switchCase.isDefault()) {
			...
			tools.mdsd.jamopp.model.java.statements.NormalSwitchRule normalRule =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createNormalSwitchRule();
			...
			tools.mdsd.jamopp.model.java.statements.NormalSwitchCase normalCase =
					tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createNormalSwitchCase();
	...
	private static tools.mdsd.jamopp.model.java.statements.CatchBlock convertToCatchBlock(CatchClause block) {
		tools.mdsd.jamopp.model.java.statements.CatchBlock result =
				tools.mdsd.jamopp.model.java.statements.StatementsFactory.eINSTANCE.createCatchBlock();
		tools.mdsd.jamopp.model.java.parameters.CatchParameter param =
				tools.mdsd.jamopp.model.java.parameters.ParametersFactory.eINSTANCE.createCatchParameter();
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.variables.AdditionalLocalVariable
		...
		tools.mdsd.jamopp.model.java.variables.AdditionalLocalVariable result =
				tools.mdsd.jamopp.model.java.variables.VariablesFactory.eINSTANCE.createAdditionalLocalVariable();
	...
	@SuppressWarnings("unchecked")
	private static tools.mdsd.jamopp.model.java.variables.LocalVariable
