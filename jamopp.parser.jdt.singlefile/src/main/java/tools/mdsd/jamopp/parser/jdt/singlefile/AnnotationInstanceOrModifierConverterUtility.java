...
class AnnotationInstanceOrModifierConverterUtility {
	static tools.mdsd.jamopp.model.java.modifiers.AnnotationInstanceOrModifier
	...
	static tools.mdsd.jamopp.model.java.annotations.AnnotationInstance convertToAnnotationInstance(Annotation annot) {
		...
		if (annot.isSingleMemberAnnotation()) {
			tools.mdsd.jamopp.model.java.annotations.SingleAnnotationParameter param =
					tools.mdsd.jamopp.model.java.annotations.AnnotationsFactory.eINSTANCE
			...
			tools.mdsd.jamopp.model.java.annotations.AnnotationParameterList param =
					tools.mdsd.jamopp.model.java.annotations.AnnotationsFactory.eINSTANCE
			...
			normalAnnot.values().forEach(obj -> {
				...
				tools.mdsd.jamopp.model.java.annotations.AnnotationAttributeSetting attrSet =
						tools.mdsd.jamopp.model.java.annotations.AnnotationsFactory.eINSTANCE
					.createAnnotationAttributeSetting();
				tools.mdsd.jamopp.model.java.members.InterfaceMethod methodProxy = tools.mdsd.jamopp.model.java.members.MembersFactory.eINSTANCE.createInterfaceMethod();
				...
				IJavaContextDependentURIFragmentCollector.GLOBAL_INSTANCE.registerContextDependentURIFragment(
					attrSet, tools.mdsd.jamopp.model.java.annotations.AnnotationsPackage.Literals
	...
	static tools.mdsd.jamopp.model.java.arrays.ArrayInitializer convertToArrayInitializer(ArrayInitializer arr) {
		tools.mdsd.jamopp.model.java.arrays.ArrayInitializer result =
