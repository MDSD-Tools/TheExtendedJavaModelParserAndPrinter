...
class ModuleJDTASTVisitorAndConverter extends PackageJDTASTVisitorAndConverter {
	...
	private tools.mdsd.jamopp.model.java.containers.Module convertToModule(ModuleDeclaration node) {
		tools.mdsd.jamopp.model.java.containers.Module module =
		...
		if (directive.getNodeType() == ASTNode.REQUIRES_DIRECTIVE) {
			...
			reqDir.modifiers().forEach(obj -> {
				...
				if (modifier.isStatic()) {
					result.setModifier(tools.mdsd.jamopp.model.java.modifiers
			...
			if (directive.getNodeType() == ASTNode.OPENS_DIRECTIVE) {
				convertedDir = tools.mdsd.jamopp.model.java.modules
			...
			tools.mdsd.jamopp.model.java.modules.UsesModuleDirective result =
					tools.mdsd.jamopp.model.java.modules.ModulesFactory.eINSTANCE.createUsesModuleDirective();
			result.setTypeReference(BaseConverterUtility
	...
	private tools.mdsd.jamopp.model.java.modules.ModuleReference convertToModuleReference(Name name) {
		tools.mdsd.jamopp.model.java.modules.ModuleReference ref =
				tools.mdsd.jamopp.model.java.modules.ModulesFactory.eINSTANCE.createModuleReference();
