...
import tools.mdsd.jamopp.options.ParserOptionsValueContainer;
import tools.mdsd.jamopp.parser.jdt.singlefile.JaMoPPJDTSingleFileParser;
import tools.mdsd.jamopp.test.xmi.JavaXMISerializationTest;
...
//		this.compare(target);
	 ...
	 *
	 * @see tools.mdsd.jamopp.options.ParserOptionsValueContainer
	 * @see tools.mdsd.jamopp.options.ParserOptions
	 */
	@BeforeEach
